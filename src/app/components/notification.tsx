    ...
    switch (status) {
        case 'check':
            return <>
                ...
                <div className="ms-3 text-sm font-normal">Sucesso</div>
            </>
        case 'error':
            return <>
        ...
        case 'warn':
            return <>
                ...
                <div className="ms-3 text-sm font-normal">Dados incorreto</div>
            </>
    }
...
export default function Notification(param: any) {
    return(
