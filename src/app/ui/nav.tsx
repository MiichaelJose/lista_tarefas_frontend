    ...
    return (
      <>
        ...
        <div className="hidden md:flex flex-col content-center items-center text-white h-4/6 w-full gap-6">
          ...
          <Link href="/display" className={` link flex w-full hover:bg-gray-800 rounded-md text-center p-3 ${pathname === '/dashboard/display' ? 'bg-gray-700/60' : ''} ${pathname === '/' ? 'active' : ''}`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
          ...
          <Link href="/task" className={`link flex w-full  hover:bg-gray-800 rounded-md text-center p-3 ${pathname === '/dashboard/display/task' ? 'bg-gray-700/60' : ''} ${pathname === '/' ? 'active' : ''} `}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
